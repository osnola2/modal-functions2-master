...
#
# get_away_draw(sheffer, K[8], (place_x, place_y+step_matrices*2))
# get_away_draw(sheffer, K[9], (place_x, place_y+step_matrices*3))
# get_away_draw(sheffer, K[10], (place_x, place_y+step_matrices*4))
# get_away_draw(sheffer, K[11], (place_x, place_y+step_matrices*5))
# get_away_draw(sheffer, K[12], (place_x, place_y+step_matrices*6))
# get_away_draw(sheffer, K[13], (place_x, place_y+step_matrices*7))
# get_away_draw(sheffer, K[14], (place_x, place_y+step_matrices*8))
# get_away_draw(sheffer, K[15], (place_x, place_y+step_matrices*9))
# get_away_draw(sheffer, K[16], (place_x, place_y+step_matrices*10))
# get_away_draw(sheffer, K[17], (place_x, place_y+step_matrices*11))
# get_away_draw(sheffer, K[21], (place_x, place_y+step_matrices*12))
# get_away_draw(sheffer, K[22], (place_x, place_y+step_matrices*13))
# get_away_draw(sheffer, K[23], (place_x, place_y+step_matrices*14))
#
#
#
