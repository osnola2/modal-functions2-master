from Tesseract.binary_functions_tess import *
...
def supendem21(prop1, prop2):
    return conj(supendem21a(prop1, prop2), supendem21b(phi(prop1, prop2), supendem21b(prop1, prop2)))
...
def fla14 (prop1, prop2):
    return conj(conj(conj(fla14a(prop1, prop2), fla14b(prop1, prop2)),
                     conj(fla14c(prop1, prop2), fla14d(prop1, prop2))), fla14e(prop1, prop2))
...
# spec_fun_1 = [box, not_cont_false, cont_true]
